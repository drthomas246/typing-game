...
export function usePage() {
	...
	if (v === undefined) throw new Error("usePage must be used within <PageProvider>");
	return v;
}
/**
 * ページ番号の更新関数を取得する。
...
export function useSetPage() {
	...
	if (set === undefined) throw new Error("useSetPage must be used within <PageProvider>");
	return set;
}
...
export function useSound() {
	...
	if (v === undefined) throw new Error("useSound must be used within <PageProvider>");
	return v;
}
/**
 * サウンド設定の更新関数を取得する。
...
export function useSetSound() {
	...
	if (set === undefined) throw new Error("useSetSound must be used within <PageProvider>");
	return set;
}
...
export function useBattle() {
	...
	if (v === undefined) throw new Error("useBattle must be used within <PageProvider>");
	return v;
}
/**
 * バトルモードの更新関数を取得する。
...
export function useSetBattle() {
	...
	if (set === undefined) throw new Error("useSetBattle must be used within <PageProvider>");
	return set;
}
...
export function useSort() {
	...
	if (v === undefined) throw new Error("useSort must be used within <PageProvider>");
	return v;
}
/**
 * 出題順設定の更新関数を取得する。
...
export function useSetSort() {
	...
	if (set === undefined) throw new Error("useSetSort must be used within <PageProvider>");
	return set;
}
...
export function useLevel() {
	...
	if (v === undefined) throw new Error("useLevel must be used within <PageProvider>");
	return v;
}
/**
 * プレイヤーレベルの更新関数を取得する。
...
export function useSetLevel() {
	...
	if (set === undefined) throw new Error("useSetLevel must be used within <PageProvider>");
	return set;
}
