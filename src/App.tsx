...
import { usePage, useSetPage, useSetSound, useSound } from "@/contexts/PageContext";
...
export default function App({ played = true }: AppProps): React.ReactElement {
	...
	const { ensurePlaying, fadeOutStop } = useBgm("./music/bgm/mainTheme.mp3", 0.4);

	const { play: playSe } = useHowlerOneShot("./music/soundEffects/screenTransition.mp3", 1.0);
